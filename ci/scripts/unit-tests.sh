...
echo "The goal is to set up a go src/github.com/JeffDeCola/RESTful-API-test directory"
...
echo "Now we must move our code from the current directory ./RESTful-API-test to" 
echo "$GOPATH/src/github.com/JeffDeCola/RESTful-API-test"
mkdir -p src/github.com/JeffDeCola/
cp -R ./RESTful-API-test src/github.com/JeffDeCola/.
echo " "

echo "cd src/github.com/JeffDeCola/RESTful-API-test"
...
echo "Placeholder to run go tests for RESTful-API-test" | tee test_coverage.txt
echo " "
